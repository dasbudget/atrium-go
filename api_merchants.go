...
func (a *MerchantsApiService) ListMerchantLocations(ctx context.Context, merchantGUID string) (MerchantLocationsResponseBody, *http.Response, error) {
	var (
		...
		localVarReturnValue MerchantLocationsResponseBody
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/merchants/{merchant_guid}/merchant_locations"
	localVarPath = strings.Replace(localVarPath, "{"+"merchant_guid"+"}", fmt.Sprintf("%v", merchantGUID), -1)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v MerchantLocationsResponseBody
...
func (a *MerchantsApiService) ReadMerchant(ctx context.Context, merchantGUID string) (MerchantResponseBody, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/merchants/{merchant_guid}"
	localVarPath = strings.Replace(localVarPath, "{"+"merchant_guid"+"}", fmt.Sprintf("%v", merchantGUID), -1)
...
*/
func (a *MerchantsApiService) ReadMerchantLocation(ctx context.Context, merchantGUID string, merchantLocationGUID string) (MerchantLocationResponseBody, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/merchants/{merchant_guid}/merchant_locations/{merchant_location_guid}"
	localVarPath = strings.Replace(localVarPath, "{"+"merchant_guid"+"}", fmt.Sprintf("%v", merchantGUID), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"merchant_location_guid"+"}", fmt.Sprintf("%v", merchantLocationGUID), -1)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v MerchantLocationResponseBody
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
